...
# Función para extraer información estructurada de una página web y mostrarla de manera bonita en la terminal
def extract_and_display_content(url):
    ...
    if response.status_code == 200:
        ...
        # Extraer los párrafos de la página y mostrarlos uno por uno
